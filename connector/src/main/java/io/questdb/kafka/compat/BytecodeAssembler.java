...
public class BytecodeAssembler {
    ...
    public void endMethodCode() {
        ...
        if (len > 64 * 1024) {
            ...
            throw new IllegalStateException("generated bytecode exceeds 64 KiB");
        }
    ...
    public <T> T newInstance() {
        ...
        try {
            ...
            throw new IllegalStateException("could not instantiate generated class", e);
        }
    }
    ...
    private <T> Class<T> loadClass(Class<?> host) {
        ...
        try {
            ...
            return (Class<T>) lookup.defineHiddenClass(
                    b,
                    false,
                    MethodHandles.Lookup.ClassOption.NESTMATE
            ).lookupClass();
        } catch (IllegalAccessException e) {
            throw new IllegalStateException("could not define generated class", e);
        }
    }
    ...
    public class Utf8Appender implements Utf8Sink {
        ...
        @Override
        public Utf8Appender putAscii(CharSequence cs) {
            if (cs != null) {
                int len = cs.length();
                for (int i = 0; i < len; i++) {
