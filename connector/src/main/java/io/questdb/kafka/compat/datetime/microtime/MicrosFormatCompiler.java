...
public class MicrosFormatCompiler {
    ...
    private DateFormat compile(IntList ops, ObjList<String> delimiters) {
        ...
        asm.setupPool();
        int thisClassIndex = asm.poolClass(asm.poolUtf8("io/questdb/kafka/compat/datetime/TimestampFormatAsm"));
        ...
        int computeIndex = asm.poolMethod(MicrosFormatUtils.class, "compute", "(Lio/questdb/kafka/compat/datetime/DateLocale;IIIIIIIIIIIJI)J");
        ...
        int appendEraIndex = asm.poolMethod(MicrosFormatUtils.class, "appendEra", "(Lio/questdb/client/std/str/CharSink;ILio/questdb/kafka/compat/datetime/DateLocale;)V");
        int appendAmPmIndex = asm.poolMethod(MicrosFormatUtils.class, "appendAmPm", "(Lio/questdb/client/std/str/CharSink;ILio/questdb/kafka/compat/datetime/DateLocale;)V");
        int appendHour12Index = asm.poolMethod(MicrosFormatUtils.class, "appendHour12", "(Lio/questdb/client/std/str/CharSink;I)V");
        int appendHour12PaddedIndex = asm.poolMethod(MicrosFormatUtils.class, "appendHour12Padded", "(Lio/questdb/client/std/str/CharSink;I)V");
        int appendHour121Index = asm.poolMethod(MicrosFormatUtils.class, "appendHour121", "(Lio/questdb/client/std/str/CharSink;I)V");
        int appendHour121PaddedIndex = asm.poolMethod(MicrosFormatUtils.class, "appendHour121Padded", "(Lio/questdb/client/std/str/CharSink;I)V");
        int appendHour241Index = asm.poolMethod(MicrosFormatUtils.class, "appendHour241", "(Lio/questdb/client/std/str/CharSink;I)V");
        int appendHour241PaddedIndex = asm.poolMethod(MicrosFormatUtils.class, "appendHour241Padded", "(Lio/questdb/client/std/str/CharSink;I)V");
        int append00000Index = asm.poolMethod(MicrosFormatUtils.class, "append00000", "(Lio/questdb/client/std/str/CharSink;I)V");
        int append00Index = asm.poolMethod(MicrosFormatUtils.class, "append00", "(Lio/questdb/client/std/str/CharSink;I)V");
        int append0Index = asm.poolMethod(MicrosFormatUtils.class, "append0", "(Lio/questdb/client/std/str/CharSink;I)V");
        int appendYear000Index = asm.poolMethod(MicrosFormatUtils.class, "appendYear000", "(Lio/questdb/client/std/str/CharSink;I)V");
        int appendYear00Index = asm.poolMethod(MicrosFormatUtils.class, "appendYear00", "(Lio/questdb/client/std/str/CharSink;I)V");
        int appendYear0Index = asm.poolMethod(MicrosFormatUtils.class, "appendYear0", "(Lio/questdb/client/std/str/CharSink;I)V");
        int appendYearIndex = asm.poolMethod(MicrosFormatUtils.class, "appendYear", "(Lio/questdb/client/std/str/CharSink;I)V");
        ...
        int sinkPutIntIndex = asm.poolInterfaceMethod(CharSink.class, "put", "(I)Lio/questdb/client/std/str/CharSink;");
        int sinkPutStrIndex = asm.poolInterfaceMethod(CharSink.class, "put", "(Ljava/lang/CharSequence;)Lio/questdb/client/std/str/CharSink;");
        int sinkPutChrIndex = asm.poolInterfaceMethod(CharSink.class, "put", "(C)Lio/questdb/client/std/str/CharSink;");

        int charAtIndex = asm.poolInterfaceMethod(charSequenceClassIndex, "charAt", "(I)C");

        int parseNameIndex = asm.poolUtf8("parse");
        int parseSigIndex = asm.poolUtf8("(Ljava/lang/CharSequence;IILio/questdb/kafka/compat/datetime/DateLocale;)J");
        int formatNameIndex = asm.poolUtf8("format");
        int formatSigIndex = asm.poolUtf8("(JLio/questdb/kafka/compat/datetime/DateLocale;Ljava/lang/CharSequence;Lio/questdb/client/std/str/CharSink;)V");
